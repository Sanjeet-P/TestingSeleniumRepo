 ...
 public static void selectProductForWomenNewIn() {
	...
	public static void verifyPaymentPage() {
		try {			
			...
			{
				System.out.println("Successfully Verifed Aerobic KW Checkout flow For Women New In Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowUAEWomenSaletab.png");

			}else{
				System.out.println("Error Coming while verifed Arobic KW Checkout flow For omen New In Tab");
