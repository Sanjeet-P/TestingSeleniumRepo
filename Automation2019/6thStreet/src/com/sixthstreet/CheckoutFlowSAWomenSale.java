...
public class CheckoutFlowSAWomenSale {
	static String  mainurl="https://en-sa.6thstreet.com/";
	static  WebDriver driver;
	

	public static void main(String[] args) throws Exception {
		saudiarabiaWomenSale();
		
	}

	public static void saudiarabiaWomenSale() throws Exception {
		try {
			openingBrowser();
			verifyURL();
	...
	public static void verifyPaymentPage() {
		try {			
			...
			{
				System.out.println("Successfully Verifed Saudi Arabia Checkout flow For Women Sale Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowSaWomenSale.png");
				
			}else{
				System.out.println("Error Coming while verifed Saudi Arabia Checkout flow For Women Sale Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowSaWomentSale.png");
			}			
		}
		catch(Exception e){
			e.getMessage();			
