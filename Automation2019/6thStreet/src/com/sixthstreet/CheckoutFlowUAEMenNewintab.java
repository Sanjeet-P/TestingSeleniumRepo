...
public class CheckoutFlowUAEMenNewintab {
	...
	public static void uaeMenNewInTab() throws Exception {
		try {
			openingBrowser();
			verifyURL();
			...
			FirstClass.takeSnapShot(driver, ".//ScreenShots//catchCheckoutFlowUAEMenNewINTab.png");
			driver.quit();
		}
	...
	public static void selectProduct() throws Exception {
		WebElement women=driver.findElement(By.xpath("//a[@title=\"Men's Store\"]"));
		women.click();
		WebElement new_In=driver.findElement(By.linkText("NEW IN"));
		Actions action = new Actions(driver);
		action.moveToElement(new_In).click().build().perform();
		WebElement product=driver.findElement(By.xpath("//div[42]//li[1]//div[1]//a[1]//img[2]"));
	...
	public static void verifyPaymentPage() {
		try {			
			...
			{
				System.out.println("Successfully Verifed UAE Checkout flow For Men New In Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowUAEMenNewIntab.png");

			}else{
				System.out.println("Error Coming while verifed UAE Checkout flow For Men New In Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowUAEMenNewIntab.png");
			}			
		}
		catch(Exception e){
			e.getMessage();			
