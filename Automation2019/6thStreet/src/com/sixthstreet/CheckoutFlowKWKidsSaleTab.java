...
public class CheckoutFlowKWKidsSaleTab {
	...
	public static void kWMenSaleTab() throws Exception {
		try {
			openingBrowser();
			verifyURL();
			selectProduct();
			...
			FirstClass.takeSnapShot(driver, ".//ScreenShots//catchCheckoutFlowKWKidsSale.png");
			driver.quit();
		}
	}
	...
	public static void selectProduct() throws Exception {
		...
		WebElement new_In=driver.findElement(By.linkText("SALE"));
	...
	public static void verifyPaymentPage() {
		try {			
			...
			{
				System.out.println("Successfully Verifed Kuwait Checkout flow For Kids Sale Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowKWkidsSaleTab.png");

			}else{
				System.out.println("Error Coming while verifed Kwait Checkout flow For Kids Sale Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowKWKidsSaleTab.png");
			}			
		}
		catch(Exception e){
			e.getMessage();			
