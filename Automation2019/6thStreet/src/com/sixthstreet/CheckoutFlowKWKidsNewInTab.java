package com.sixthstreet;
	...
	public class CheckoutFlowKWKidsNewInTab {
		...
		public static void kWKidsNewInTab() throws Exception {
			try {
				openingBrowser();
				verifyURL();
				...
				FirstClass.takeSnapShot(driver, ".//ScreenShots//catchCheckoutFlowKuwaitKidsNewINTab.png");
				driver.quit();
			}
		...
		public static void selectProduct() throws Exception {
			...
			WebElement product=driver.findElement(By.xpath("//div[@class='ais-hits']//div[1]//li[1]//div[1]//a[1]//img[1]"));
		...
		public static void clickOnAddToBagButton() throws Exception {
			...
			for(int i =0; i < iListSize ; i++){
				...
				if(sValue.equals("5Y-1 left in stock")){
		...
		public static void verifyPaymentPage() {
			try {			
				...
				{
					System.out.println("Successfully Verifed Kuwait  Checkout flow For Kids New In Tab");
					FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowKWKidsNewIntab.png");

				}else{
					System.out.println("Error Coming while verifed Kwuait Checkout flow For Kids New In Tab");
					FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowKWKidsNewIntab.png");
				}			
			}
			catch(Exception e){
				e.getMessage();			
