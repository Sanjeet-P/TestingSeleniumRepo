...
public class CheckoutFlowKWMenSaleTab {
	...
	public static void verifyPaymentPage() {
		try {			
			...
			{
				System.out.println("Successfully Verifed Kuwait Checkout flow For Men Sale Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowKWMenSaleTab.png");

			}else{
				System.out.println("Error Coming while verifed Saudi Arabia Checkout flow For New In Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowKWMenSaleTab.png");
			}			
		}
		catch(Exception e){
			e.getMessage();			
