package com.sixthstreet;
	...
	public class CheckoutFlowKWMenNewInTab {
		...
		public static void kWMenNewInTab() throws Exception {
			try {
				openingBrowser();
				verifyURL();
				selectProduct();
		...
		public static void verifyPaymentPage() {
			try {			
				...
				{
					System.out.println("Successfully Verifed Kuwait Checkout flow For Men New In Tab");
					FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowKWMenNewInTab.png");

				}else{
					System.out.println("Error Coming while verifed Saudi Arabia Checkout flow For Men New In Tab");
					FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowKMenNewInTab.png");
				}			
			}
			catch(Exception e){
				e.getMessage();			
