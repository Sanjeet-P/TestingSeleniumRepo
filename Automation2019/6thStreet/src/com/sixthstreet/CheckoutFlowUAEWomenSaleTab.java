...
public class CheckoutFlowUAEWomenSaleTab {
	...
	public static void uaeWomenSaleTab() throws Exception {
		try {
			openingBrowser();
			verifyURL();
	...
	public static void verifyPaymentPage() {
		try {			
			...
			{
				System.out.println("Successfully Verifed UAE Checkout flow For Women Sale Tab");
