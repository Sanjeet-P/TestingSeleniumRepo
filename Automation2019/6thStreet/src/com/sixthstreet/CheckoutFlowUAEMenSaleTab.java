	...
	public class CheckoutFlowUAEMenSaleTab {
		...
		public static void uaeMenSaleTab() throws Exception {
			try {
				...
				FirstClass.takeSnapShot(driver, ".//ScreenShots//catchCheckoutFlowUAEMenSaleTabpic.png");
				driver.quit();
			}
		...
		public static void verifyPaymentPage() {
			try {			
				...
				{
					System.out.println("Successfully Verifed UAE Checkout flow For Men Sale  Tab");
					FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowUAEMenSaletab.png");

				}else{
					System.out.println("Error Coming while verifed UAE Checkout flow For Men Sale Tab");
					FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowUAEMenSaletab.png");
				}			
			}
			catch(Exception e){
				e.getMessage();			
