...
public class CheckoutFlowSAMenSaletab {
	static String  mainurl="https://en-sa.6thstreet.com/";
	static  WebDriver driver;


	public static void main(String[] args) throws Exception {
		saudiarabiaMenSaleTab();

	}

	public static void saudiarabiaMenSaleTab() throws Exception {
		try {
			openingBrowser();
			verifyURL();
	...
	public static void verifyPaymentPage() {
		try {			
			...
			{
				System.out.println("Successfully Verifed Saudi Arabia Checkout flow For MEN Sale Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowSaMenSaleTab.png");

			}else{
				System.out.println("Error Coming while verifed Saudi Arabia Checkout flow For MEN Sale Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowSaMenSaleTab.png");
			}			
		}
		catch(Exception e){
			e.getMessage();			
