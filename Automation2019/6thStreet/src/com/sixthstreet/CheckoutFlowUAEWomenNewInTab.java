...
public class CheckoutFlowUAEWomenNewInTab {
	...
	public static void uaeWomenNewInTab() throws Exception {
		try {
			openingBrowser();
			verifyURL();
	...
	public static void selectProduct() throws Exception {
		...
		WebElement product=driver.findElement(By.xpath("//div[38]//li[1]//div[1]//a[1]//img[2]"));
	...
	public static void verifyPaymentPage() {
		try {			
			...
			{
				System.out.println("Successfully Verifed UAE Checkout flow For Women New In Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//SuccessfullyVerifiedCheckoutFlowUAEWomenNewIntab.png");

			}else{
				System.out.println("Error Coming while verifed UAE Checkout flow For Women New In Tab");
				FirstClass.takeSnapShot(driver, ".//ScreenShots//ErrorComingInCheckoutFlowUAEWomenNewIntab.png");
			}			
		}
		catch(Exception e){
			e.getMessage();			
